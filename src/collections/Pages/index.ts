...
import { proteqLayoutBlocks } from '../../blocks/proteq/layoutBlocks'
import { proteqHero } from '@/heros/proteqConfig'
import { slugField } from 'payload'
import { populatePublishedAt } from '../../hooks/populatePublishedAt'
import { generatePreviewPath } from '../../utilities/generatePreviewPath'
import { revalidateDelete, revalidatePage } from './hooks/revalidatePage'
import {
  migrateRichTextFieldsAfterRead,
  migrateRichTextFieldsBeforeChange,
} from './hooks/migrateRichTextFields'
...
export const Pages: CollectionConfig = {
  ...
  hooks: {
    ...
    afterRead: [migrateRichTextFieldsAfterRead],
    beforeChange: [populatePublishedAt, migrateRichTextFieldsBeforeChange],
